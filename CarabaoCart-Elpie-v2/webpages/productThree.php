    ...
    <div class="container">
        <div class="product-info">
            <div class="product-image">
                <img src="../images/milk3.png" alt="Chocolate Milk">
            </div>
            <div class="product-details">
                <div class="form-control">
                    <label>Product: Chocolate Milk</label>
        ...
        <?php
            ...
            foreach ($xmlFiles as $xmlFile) {
                ...
                foreach ($xml->Product as $product) {
                    if ((string)$product['name'] === "Chocolate Milk") {
        ...
        <form action="../Php/save_order.php" method="post">
            <!--Hidden Inputs-->
            <input type="hidden" name="productName" id="productName" value="Chocolate Milk">
