    ...
    <div class="container">
        <div class="product-info">
            <div class="product-image">
                <img src="../images/cheese.png" alt="Milk Cheese">
            </div>
            <div class="product-details">
                <div class="form-control">
                    <label>Product: Milk Cheese</label>
                    <label id="productPrice">Price: ₱100.00</label>        
                </div>
        ...
        <?php
            ...
            foreach ($xmlFiles as $xmlFile) {
                ...
                foreach ($xml->Product as $product) {
                    if ((string)$product['name'] === "Milk Cheese") {
        ...
        <form action="../Php/save_order.php" method="post">
            <!--Hidden Inputs-->
            <input type="hidden" name="productName" id="productName" value="Milk Cheese">
