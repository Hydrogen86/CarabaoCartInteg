    ...
    <div class="container">
        <div class="product-info">
            <div class="product-image">
                <img src="../images/milk2.png" alt="StrawberryMilk">
            </div>
            <div class="product-details">
                <div class="form-control">
                    <label>Product: Strawberry Milk</label>
                    <label id="productPrice">Price: ₱160.00</label>        
                </div>
        ...
        <?php
            ...
            foreach ($xmlFiles as $xmlFile) {
                ...
                foreach ($xml->Product as $product) {
                    if ((string)$product['name'] === "Strawberry Milk") {
        ...
        <form action="../Php/save_order.php" method="post">
            <!--Hidden Inputs-->
            <input type="hidden" name="productName" id="productName" value="Strawberry Milk">
            <input type="hidden" name="productPrice" id="productPrice" value="160">
            <div class="form-control">
